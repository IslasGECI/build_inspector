Describe 'geci-makeall.sh'
  ...
  It 'Notifies healtchecks.io'
    ...
    The line 3 of output should equal "curl --data-raw reporte_1.pdf@repositorio:abcd --fail --max-time 10 --retry 5 --show-error --silent https://hc-ping.com/1234567890/start"
    ...
    The line 25 of output should equal "curl --data-raw geci-makeall@repositorio:develop --fail --max-time 10 --retry 5 --show-error --silent https://hc-ping.com/1234567890"
